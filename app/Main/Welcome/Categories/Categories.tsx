  ...
  return (
    <section className={styles.categories}>
      <section>
        ...
        <Link href="products/homeandkitchen" className={styles.link}>
          <svg
            viewBox="0 0 576 512"
            height="22px"
            width="22px"
        ...
        <Link href="products/beautyandhealth" className={styles.link}>
          <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
        ...
        <Link href="products/gamesandtoys" className={styles.link}>
          <svg viewBox="0 0 640 512" fill="#e8eaed" role="img">
      ...
      <section>
        ...
        <Link href="meals/instantandsnacks" className={styles.link}>
          <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
        ...
        <Link href="meals/frozenfoods" className={styles.link}>
          <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
        ...
        <Link href="meals/veganandvegetarian" className={styles.link}>
          <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
        ...
        <Link href="meals/mealprep" className={styles.link}>
          <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
      ...
      <section>
        <h3>Services</h3>
        <Link href="services/beautyandwellness" className={styles.link}>
          <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
        ...
        <Link href="services/academic" className={styles.link}>
          <svg viewBox="0 0 640 512" fill="#e8eaed" role="img">
