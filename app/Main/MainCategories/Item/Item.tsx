  ...
  return (
    <section className={styles.item}>
      ...
      <div className={styles.productInfo}>
        ...
        {!addedToCart ? (
          <button className={styles.add} onClick={() => setAddedToCart(true)}>
            Add to cart
          </button>
        ) : (
          <div className={styles.addQuantity}>
            <svg viewBox="0 0 448 512" onClick={decrementQuantity}>
            ...
            <span>{quantity}</span>
            <svg viewBox="0 0 448 512" onClick={incrementQuantity}>
