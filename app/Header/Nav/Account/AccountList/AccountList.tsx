...
function AccountList({ onLogoutClick }: Props) {
  ...
  return (
    <section className={styles.accountList}>
      ...
      <section
        className={`${styles.otherList} ${user.id ? styles.loggedIn : ""}`}
      >
        {user.id && (
          <>
            <Link href="/store">
            ...
            <Link href="/menu" onClick={() => dispatch(setMenu("Inbox"))}>
        ...
        <Link href="/menu" onClick={() => dispatch(setMenu("WishList"))}>
          <svg role="img" viewBox="0 0 512 512">
