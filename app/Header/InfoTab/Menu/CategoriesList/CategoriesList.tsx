  ...
  return (
    <div className={styles.categoriesList}>
      <div className={styles.products}>
        <h3>Products</h3>
        <div>
          <Link href="products/electronics" className={styles.link}>
          ...
          <Link href="products/fashion" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="products/academic" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="products/home-and-kitchen" className={styles.link}>
            <svg
              viewBox="0 0 576 512"
              height="22px"
              width="22px"
          ...
          <Link href="products/beauty-and-health" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="products/sports" className={styles.link}>
          ...
          <Link href="products/games-and-toys" className={styles.link}>
            <svg viewBox="0 0 640 512" fill="#e8eaed" role="img">
          ...
          <Link href="products/automotive" className={styles.link}>
            <svg viewBox="0 0 640 512" fill="#e8eaed" role="img">
      ...
      <div className={styles.meals}>
        <h3>Meals</h3>
        <div>
          <Link href="meals/beverages" className={styles.link}>
          ...
          <Link href="meals/bakery" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="meals/international" className={styles.link}>
            <svg viewBox="0 0 512 512" fill="#e8eaed" role="img">
          ...
          <Link href="meals/native" className={styles.link}>
            <svg viewBox="0 0 512 512" fill="#e8eaed" role="img">
          ...
          <Link href="meals/instant-and-snacks" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="meals/frozen-foods" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="meals/vegan-and-vegetarian" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="meals/meal-prep-subscriptions" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
      ...
      <div className={styles.services}>
        <h3>Services</h3>
        <div>
          <Link href="services/beauty-and-wellness" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="services/home" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
          ...
          <Link href="services/tech" className={styles.link}>
            <svg viewBox="0 0 640 512" fill="#e8eaed" role="img">
          ...
          <Link href="services/academic-services" className={styles.link}>
            <svg viewBox="0 0 640 512" fill="#e8eaed" role="img">
          ...
          <Link href="services/logistics" className={styles.link}>
            <svg viewBox="0 -960 960 960" fill="#e8eaed" role="img">
