              ...
              <section className={styles.comments} key={index}>
                ...
                <section className={styles.commentBox}>
                  <p className={styles.comment}>
                    ...
                    Est ab maxime quam voluptatibus, quaerat quisquam facere
                    accusamus praesentium saepe sed doloremque debitis tempore
                    ut blanditiis expedita qui doloribus. Cupiditate, quae.
                  </p>
